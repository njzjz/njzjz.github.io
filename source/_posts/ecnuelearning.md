...
![](https://api.njzjz.win/1NqJekNBYorEDvHOgnWK9N1CFxaGju3ts)

日程表最下方有个“获取外部日程表链接”，点开后就可以看到一个地址(ics格式)。

![](https://api.njzjz.win/19bEe1BJ1vLoqfFL8y6mP1GomrYJKmYlM)

下面就是同步到日历了，下面以Outlook日历为例：（不知道其他邮箱有没有这功能，总之微软大法好）

添加日历>>从Internet>>然后填写刚才生成的地址

![](https://api.njzjz.win/1lcPnNX5SARYTfubQBiqh0r8CmSoVpTw_)
...
![](https://api.njzjz.win/1LirDsNYmdnY-z92rcwxpGXwhJs09sgpX)

一坨作业在本月末截止：

![](https://api.njzjz.win/1Hcikf-jl-IaygkKzIxKNl6mThx349gtC)
